...
/*:
 * @plugindesc (v.1.0) Nameplates (ANETZ Extension)
 * @author Pheonix KageDesu
 * @target MZ MV
 * @url https://gist.github.com/KageDesu/192e2359147c9979d344cddbec364e1f
 *
 * 
 * @help
 * ---------------------------------------------------------------------------
 ...
 *
 * GUIDE:
 * https://gist.github.com/KageDesu/192e2359147c9979d344cddbec364e1f
 *
 * ---------------------------------------------------------------------------
 *
 * Boosty:
 ...
 * License: Creative Commons 4.0 Attribution, Share Alike, Commercial
 * 
 * @param Alpha_NETZ_Ext_Nameplates
 * @text Alpha NET Z Extension - Nameplates
 * 
 * 
 ...
 * @desc Default and custom nameplate styles
 * 
 * 
 ...
 * 
 * @param Alpha_NETZ_Ext_Nameplates
 * @text Alpha NET Z Расширение - Таблички с именами
 * 
 * 
 ...
 * @off Player Name
 * @default true
 * @desc Имя персонажа или игрока на табличке с именем
 * 
 * 
 ...
 * @param isShowMyNameplate:b
 * @parent isUseNameplates:b
 * @text Моя табличка с именем?
 * @type boolean
 * @on Show
 * @off No, only for other
 * @default false
 * @desc Если ВКЛ, игрок также увидит табличку с именем над собственным персонажем
 * 
 * 
 ...
 * @type struct<NameplateStyle>[]
 * @default ["{\"id:str\":\"default\",\"margins:s\":\"{\\\"x:int\\\":\\\"-27\\\",\\\"y:int\\\":\\\"-20\\\"}\",\"backImage:s\":\"{\\\"visible:b\\\":\\\"false\\\",\\\"image:str\\\":\\\"\\\"}\",\"backImageMargins:s\":\"{\\\"x:int\\\":\\\"0\\\",\\\"y:int\\\":\\\"0\\\"}\",\"backRect:s\":\"{\\\"visible:bool\\\":\\\"true\\\",\\\"size:struct\\\":\\\"{\\\\\\\"w:int\\\\\\\":\\\\\\\"54\\\\\\\",\\\\\\\"h:int\\\\\\\":\\\\\\\"18\\\\\\\"}\\\",\\\"fillColor:str\\\":\\\"#000000\\\",\\\"fillOpacity:i\\\":\\\"120\\\",\\\"borderColor:str\\\":\\\"#000000\\\",\\\"borderThickness:i\\\":\\\"1\\\",\\\"borderOpacity:i\\\":\\\"255\\\"}\",\"backRectMargins:s\":\"{\\\"x:int\\\":\\\"0\\\",\\\"y:int\\\":\\\"0\\\"}\",\"text:s\":\"{\\\"visible:bool\\\":\\\"true\\\",\\\"size:struct\\\":\\\"{\\\\\\\"w:int\\\\\\\":\\\\\\\"54\\\\\\\",\\\\\\\"h:int\\\\\\\":\\\\\\\"18\\\\\\\"}\\\",\\\"font:struct\\\":\\\"{\\\\\\\"face:str\\\\\\\":\\\\\\\"\\\\\\\",\\\\\\\"size:int\\\\\\\":\\\\\\\"12\\\\\\\",\\\\\\\"italic:bool\\\\\\\":\\\\\\\"false\\\\\\\"}\\\",\\\"margins:struct\\\":\\\"{\\\\\\\"x:int\\\\\\\":\\\\\\\"0\\\\\\\",\\\\\\\"y:int\\\\\\\":\\\\\\\"0\\\\\\\"}\\\"}\"}"]
 * @desc Стандартные и пользовательские стили табличек с именами
 * 
 * 
...
@text ID стиля
@type text
@desc Уникальный ID стиля. Используется в скриптовом вызове: nAPI.setNameplateStyle
@default default
...
@text Отступы
@type struct<str2>
@desc Смещение таблички относительно спрайта персонажа
@default {}
...
@text Отступы
@type struct<str2>
@desc Смещение фоновое изображение относительно таблички
@default {}
...
@text Отступы
@type struct<str2>
@desc Смещение фоновой заливки относительно таблички
@default {}
...
@type text
@default #000000
@desc Цвет контура в формате HEX (#000000) или пустая строка "" (черный)
...
@default 3
@min 0
@desc Толщина контура в пикселях
*/
...
@min 0
@max 255
@desc От 0 до 255, 0 - прозрачный, 255 - непрозрачный
@default 220
...
@type number
@min 0
@desc Толщина границ в пикселях. 0 - без границ
@default 0
...
/*~struct~NameplateStyle:zh-ch

@param id:str
@text 样式ID
@type text
@desc 独特的样式ID。在脚本调用中使用：nAPI.setNameplateStyle
@default default
...
@type text
@default #000000
@desc 轮廓颜色的HEX格式（#000000）或空字符串""（黑色）
...
var Imported;
(function (Imported) {
    Imported.Alpha_NETZ_Ext_Nameplates = true;
})(Imported || (Imported = {}));
var Alpha_NETZ_Ext_Nameplates;
(function (Alpha_NETZ_Ext_Nameplates) {
    Alpha_NETZ_Ext_Nameplates.Version = "1.0";
})(Alpha_NETZ_Ext_Nameplates || (Alpha_NETZ_Ext_Nameplates = {}));
...
(function (PP) {
    ...
    */
    function LoadPluginSettings() {
        _loader = new NZKDX.ParamLoader("Alpha_NETZ_Ext_Nameplates");
    }
    ...
    */
    ...
    function isShowActorNameInNameplate() {
        return getLoaderParam('isShowActorNameInNameplate', true);
    }
    PP.isShowActorNameInNameplate = isShowActorNameInNameplate;
    function isShowNameplateOverMyCharacter() {
        return getLoaderParam('isShowMyNameplate', true);
    }
    PP.isShowNameplateOverMyCharacter = isShowNameplateOverMyCharacter;
    function getNameplateStyles() {
        return getLoaderParam('nameplatesDB', []);
    }
    PP.getNameplateStyles = getNameplateStyles;
})(PP || (PP = {}));
...
//---------------------------------------------------------------------------
(function() {
  var ALIAS__onRefreshGameParty, _;
  //@[DEFINES]
  _ = ANGameManager;
  //@[ALIAS]
  ALIAS__onRefreshGameParty = _.onRefreshGameParty;
  _.onRefreshGameParty = function() {
    ALIAS__onRefreshGameParty.call(this, ...arguments);
...
(function() {
  ...
  _.sendNameplatesStyles = function() {
    ...
    try {
      ...
      return ANNetwork.send(NetMessage.Common("custom_nameplates", data));
    } catch (error) {
      e = error;
...
(function() {
  ...
  _.nGetNameplate = function() {
    ...
    try {
      if (PP.isShowActorNameInNameplate()) {
        name = this.name();
      } else {
...
(function() {
  ...
  _.nGetNameplate = function() {
    ...
    if ((actor != null) && PP.isShowNameplateOverMyCharacter() === true) {
...
(function() {
  ...
  _.nSetNameplateStyleForActor = function(actorId, style) {
    ...
    try {
      if ((style != null) && KString.any(style)) {
...
(function() {
  ...
  _.event_common_forClients = function(content) {
    ...
    try {
      ({cmd, data} = content);
      if (cmd.contains("nameplates")) {
        ANPlayersManager.onPlayersNameplatesStyles(data);
        return;
      }
    } catch (error) {
      e = error;
...
(() => {
    ...
    _.start = function () {
        ...
        if (!Imported['Alpha_NETZ']) {
            ...
            window.alert("Nameplates Extension plugin require Alpha NETZ!");
            return;
        }
        PP.LoadPluginSettings();
        ANET.registerExtension("Nameplates");
    };
})();
// ■ END Scene_Boot.ts
//---------------------------------------------------------------------------
...
(function() {
  ...
  _.updateOther = function() {
    ...
    return this._updateNetworkNameplate();
  };
...
(function() {
  ...
  Sprite_NetCharNameplate = class Sprite_NetCharNameplate extends Sprite {
    constructor() {
      super();
    }
  ...
  _._createBackImage = function(styleData) {
    var e, styleData2;
    try {
      styleData2 = styleData.backImage;
      styleData2.rootImageFolder = "pictures";
      this.imageElement = new KDCore.UI.Sprite_UIImage(styleData2);
...
//---------------------------------------------------------------------------
(function() {
  var ALIAS__refreshNetworkCharacters, _;
  //@[DEFINES]
  _ = Spriteset_Map.prototype;
  //@[ALIAS]
  ALIAS__refreshNetworkCharacters = _.refreshNetworkCharacters;
  _.refreshNetworkCharacters = function() {
    ALIAS__refreshNetworkCharacters.call(this, ...arguments);
    return nAPI.requestNameplatesRefresh();
  };
